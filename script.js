...
// ---------- Featured carousel ----------
const featuredIds = ['halcyon-vantis', 'ravenna-onyx', 'nordfell-terra', 'astorra-prime', 'velmont-regal'];
...
function renderCarousel() {
  ...
  carouselSlide.innerHTML = `
    <div class="carousel__media">${carSilhouette(brandColors[car.brand])}</div>
